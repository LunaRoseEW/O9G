<nav class="navbar navbar-expand-lg navbar-dark bg-dark static-top">
            <div class="container-fluid">
                <a class="navbar-brand mb-0 h1" href="#"><h3>Obnoxious 9 Games</h3></a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="#"><h6>Articles</h6></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="#"><h6>Decklists</h6></a>
                        </li>
                    </ul>
